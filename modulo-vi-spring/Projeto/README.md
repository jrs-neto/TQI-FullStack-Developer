...
Nesta atividade, tive a oportunidade de aprender a testar, unitariamente, uma API REST para o gerenciamento de estoques de cerveja. Desenvolvendo testes unitários para validar o sistema de gerenciamento de estoques de cerveja, e também visualizar os principais conceitos e vantagens de criar testes unitários com JUnit e Mockito.
